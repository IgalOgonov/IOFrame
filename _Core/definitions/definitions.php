...
//-------------------Opens definitions.json and defines them.
    if(file_exists(__DIR__.'/definitions.json')){
        ...
        $myfile = fopen(__DIR__.'/definitions.json', "r+") or die("Unable to open definitions file!");
        $definitions = json_decode( fread($myfile,(filesize(__DIR__.'/definitions.json')+1)) , true );
        fclose($myfile);
