...
namespace IOFrame{
     ...
     * @param string $currAdr needs to be the callers $_SERVER['PHP_SELF']
    ...
    /** Works ONLY if THIS FUNCTION is in a predefined folder - _util.
    * @returns string absolute server root path */
    function getAbsPath(){
        $path=__DIR__;
        $length = strlen($path);
        $path = substr($path,0,$length-strlen('_util'));
    ...
    */
     ...
     * @param settingsHandler $settings IOFrame setting handler
    ...
    */
    ...
    /** Checks whether a string is a JSON string
     * @param string $str
     * @returns boolean
    */
    ...
    */
     ...
     * */
    function log_level_at_least(int $level, settingsHandler $siteSettings){
