...
namespace IOFrame{
    ...
    class PHPQueryBuilder
    {
        ...
        */
         ...
         * $limit2 = ['=', '<=>', '!=', '<=', '>=', '<', '>', 'IS', 'IS NOT', 'LIKE', 'NOT LIKE', ':=', 'ATAN', 'LOG', 'ROUND',
         ...
         *
         *                   Example 3: [[$tableName,[['Page_Name',"cp/objects.php",'='],['Last_Changed',$testMetaTime,'>'],'AND'],['Page_Name'],[],'SELECT'],'EXISTS']
         *                              translates to
         *                              EXISTS( SELECT Page_Name FROM OBJECT_MAP WHERE ( ( Page_Name = 'cp/objects.php' ) AND ( Last_Changed > 0 ) ) )
         * @param bool $useContext Use context clues, as explained above and implemented in assertTypes in case of a string
         * @param bool $useClues Use stractural clues, as explained above and implemented in assertTypes in case of a string
