Vue.component('gallery-editor', {
    ...
    template: `
         <div class="gallery-editor">
            ...
            <div class="info-container">
                ...
                <div v-if="needViewer">
                    <h1 >Select images from below:</h1>
    ...
    created:function(){
        ...
        for(let i in document.ioframe.languages){
            this.expectedNames.push(document.ioframe.languages[i]+'_name');
        }
        ...
        for(let i in this.expectedNames){
            ...
            Vue.set(this.galleryNames,name,{
                original:existing,
                current:existing,
                text:(!document.ioframe.languages[i-1] ? 'Gallery Name' : 'Gallery Name ['+document.ioframe.languages[i-1]+']')
            });
        }
    },
