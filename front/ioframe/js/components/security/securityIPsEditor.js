Vue.component('security-ips-editor', {
            ...
            paramMap:{
                ...
                'IP':{
                    ...
                    onUpdate:{
                        ...
                        validateFailureMessage: 'IP must be a valid IPv4"!'
                    }
                },
                'reliable':{
                    title: 'Reliable?',
    ...
    methods:{
        ...
        setItem: function(){
            ...
            data.append('action', (this.mode === 'create' ? 'addIP' : 'updateIP') );
            if(this.test)
