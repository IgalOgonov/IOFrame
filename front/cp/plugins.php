...
<div class="wrapper">
    <?php require $settings->getSetting('absPathToRoot').'front/ioframe/templates/modules/plugins.php'?>
    <?php require $settings->getSetting('absPathToRoot').'front/ioframe/templates/modules/pluginList.php'?>
</div>
