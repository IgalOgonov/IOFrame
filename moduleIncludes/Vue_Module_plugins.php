    ...
    var pluginList = new Vue({
        ...
        data: {
            ...
            ghost_test:{            //Test plugin for client side. The fileName is illegal, so it will always return an error when sent.
                ...
                installStatus:'quick',
                icon:'pluginImages/def_icon.png',
                thumbnail:'pluginImages/def_thumbnail.png',
        ...
        methods: {
            ...
            handleForm: function(){
                ...
                if(expectedOptions!== 'fi' && expectedOptions !=='fu'){
                    ...
                    let url=document.pathToRoot+'_siteAPI/pluginAPI.php';
                    let sendData = '';
                    ...
                    switch (expectedOptions){
                        case 'fi':
                            ...
                            redirect = redirect+'/../../_siteAPI/pluginAPI.php?name='+this.currentPlugin+'&action=fullInstall';
                        ...
                        case 'fu':
                            redirect = location.href;
                            redirect = redirect.substring(0, redirect.indexOf('/plugins')+8);
                            redirect = redirect+'/../../_siteAPI/pluginAPI.php?name='+this.currentPlugin+'&action=fullUninstall';
                            if(pluginList.testMode)
                                redirect += '&req=test';
                            location.assign(redirect);
                            break;
