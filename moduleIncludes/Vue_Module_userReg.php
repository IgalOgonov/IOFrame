                    ...
                    xhr.onreadystatechange = function () {
                        ...
                        if (xhr.readyState === DONE) {
                            if (xhr.status === OK){
                                ...
                                // success
                                userReg.test1 = "Posted: "+data+" to "+document.pathToRoot+"_siteAPI/userAPI.php"+" ,Succeeded in getting response to post.";
                                ...
                                switch(response){
                                    case '-2':
                                        userReg.resp = 'User creation failed - authorization failure!';
                                        respType='warning';
                                        break;
                                    case '-1':
                                        userReg.resp = 'User creation failed - incorrect input';
                                        respType='warning';
                                        break;
                                    case '0':
                            ...
                            if(xhr.status < 200 || xhr.status > 299 ){
                                // error
                                userReg.test1 = "Posted: "+data+"to"+document.pathToRoot+"_siteAPI/userAPI.php"+" ,Failed in getting response to post.";
