...
<!DOCTYPE html>
<?php require_once $settings->getSetting('absPathToRoot').'front/templates/ioframe/headers.php';
...
<h1>API Test</h1>
<?php include $settings->getSetting('absPathToRoot').'front/templates/ioframe/modules/apiTest.php'?>
