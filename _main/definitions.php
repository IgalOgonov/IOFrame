...
namespace IOFrame{
    ...
    const DB_LOCK_FILE =  __DIR__.'\..\_siteFiles\nodeDatabase.lock'; //locks database operations inside the node.
    const PLUGIN_IMAGE_FOLDER = 'pluginImages';
...
//-------------------Opens definitions.json and defines them.
    $dynamicDefinitions = __DIR__.'\..\_siteFiles\definitions\definitions.json';
    $dynamicDefinitionsFolder = __DIR__.'\..\_siteFiles\definitions';
